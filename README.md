...
| **Example of Early Stopper 3** | **Bleu Score** |**IBleu Score** |**Bleu Score (to Original Text)** 
|----------------|-----------|------- | --  |    
|Epoch 2 |46.51           | 32.85      | 90.17
|Epoch 5 |45.34           | 32.48| 83.21 

This perfectly shows that even though the two metrics used slightly decreased, the model was still learning to rephrase properly which was lost due to the early stopping since we optimized for Bleu.
